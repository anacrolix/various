...
Public Const SurfBG = 0                     'Constants allowing change of textures
Public Const SurfBat = 1
Public Const SurfBall = 2
...
LoadSurface App.Path & "\backgrnd.bmp", False
'Load the sprite surface - D3D Surface is true so we can use alpha blending, etc.
LoadSurface App.Path & "\bat.bmp", True
LoadSurface App.Path & "\ball.bmp", True
End Sub
