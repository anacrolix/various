...
class TextDropTarget(TextDropTarget):
...
class FileDropTarget(FileDropTarget):
...
class MainWindow(Frame):
   ...
   def __init__(self,parent,id,title):
       Frame.__init__(self,parent,-4, title, size = (800,600), style=DEFAULT_FRAME_STYLE|NO_FULL_REPAINT_ON_RESIZE)
       ...
       # Label the control
       StaticText(self, -1, "Text Drag Source  (left-click to select, right-click to drag)", (10, 1))
       # Create a Text Control
       self.text = TextCtrl(self, DRAG_SOURCE, "", pos=(10,15), size=(350,500), style = TE_MULTILINE|HSCROLL)
