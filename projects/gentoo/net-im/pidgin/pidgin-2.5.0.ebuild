...
# $Header: /var/cvsroot/gentoo-x86/net-im/pidgin/pidgin-2.5.0.ebuild,v 1.2 2008/08/20 15:56:18 tester Exp $
...
src_unpack() {
	...
	cd "${S}"
	epatch "${FILESDIR}/pidgin-2.5.0-always_transfer_images.patch"
}
