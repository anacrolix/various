...
Private Sub CheckForAdvance( _
    ...
    If (oldLevel <> curLevel And Abs(oldLevel - curLevel) <> 4) Or oldProgress <> curProgress Then
        Log FEEDBACK, 100 - curProgress & "% to " & curLevel + 1 & " " & skillName & " remaining."
...
Sub Update()
    ...
    Exit Sub
Problem:
    Log CRITICAL, "There was a problem updating experience records or checking for advances."
End Sub
