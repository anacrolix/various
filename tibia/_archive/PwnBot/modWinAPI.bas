...
Public Declare Function EncipherXteaPacket Lib "erudll.dll" (ByRef packet As Byte, ByVal length As Long, ByRef key As Byte) As Long
Public Declare Function DecipherXteaPacket Lib "erudll.dll" (ByRef packet As Byte, ByVal length As Long, ByRef key As Byte) As Long
Public Declare Function GetTibiaWindow Lib "erudll.dll" () As Long
