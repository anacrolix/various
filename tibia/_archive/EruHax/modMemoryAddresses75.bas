Attribute VB_Name = "modMemoryAddresses75"
Public Const ADDRESS_BATTLE_FIRST = &H49D094 'first entry in battle list
...
Public Const ADDRESS_EXPERIENCE = &H49D020 'static player current exp
Public Const ADDRESS_BATTLE_LAST = ADDRESS_BATTLE_FIRST + LENGTH_BATTLE_ARRAY * LENGTH_BATTLE_ENTRY
