...
Public Function Packet_FaceDirection(dir As Long) As Byte()
    Dim buff() As Byte
    ReDim buff(9)
    buff(0) = UBound(buff) - 1
    buff(1) = 0
...
Public Function Packet_ChangeOutfitEx(outfit() As Long) As Byte()
    Debug.Assert UBound(outfit) = 5
    Dim buff(17) As Byte
